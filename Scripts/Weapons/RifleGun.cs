...
public partial class RifleGun : Node2D
{
    [Signal]
    public delegate void AmmoChangedEventHandler(int ammoInMagazine, int ammoInReserve);

    private int _ammoInMagazine = 20;
    private int _ammoInReserve = 100;
    ...
    public override void _Ready()
    {
        ...
        _bulletScene = GD.Load<PackedScene>("res://Scenes/Bullets/RifleBullet.tscn");
    }
    ...
    {
        if (Input.IsActionJustPressed("reload") && !_isReloading && _ammoInMagazine < 20)
        {
            StartReload();
        }
    }
    ...
    {
        _isReloading = false;
        int ammoNeeded = 20 - _ammoInMagazine;
