...
public partial class PistolGun : Node2D
{
    [Signal]
    public delegate void AmmoChangedEventHandler(int ammoInMagazine, int ammoInReserve);

    private int _ammoInMagazine = 12;
    private int _ammoInReserve = 72;
    ...
    public override void _Ready()
    {
        ...
        _bulletScene = GD.Load<PackedScene>("res://Scenes/Bullets/PistolBullet.tscn");
    }
    ...
    {
        if (Input.IsActionJustPressed("reload") && !_isReloading && _ammoInMagazine < 12)
        {
            StartReload();
        }
    }
    ...
    {
        _isReloading = false;
        int ammoNeeded = 12 - _ammoInMagazine;
